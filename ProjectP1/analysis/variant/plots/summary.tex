...
file & 58.9\% & 2.19 & 53.6\% & 37 &3 \\ 
\end{tabular}
\vspace{2em}
\begin{itemize}[-]
\setlength{\itemsep}{0pt}
\item file .. \texttt{\footnotesize file.vcf.gz}
\end{itemize}\end{minipage}}


% Ts/Tv by sample
%
\hslide{Ts/Tv by sample}{\vbox{\centerline{\includegraphics[height=7cm]{{tstv_by_sample.0}.pdf}}}}

% Hets vs non-ref Homs by sample
%
\hslide{Hets vs non-ref Homs by sample}{\vbox{\centerline{\includegraphics[height=7cm]{{hets_by_sample.0}.pdf}}}}

% Singletons by sample {\normalsize(hets and homs)}
%
\hslide{Singletons by sample {\normalsize(hets and homs)}}{\vbox{\centerline{\includegraphics[height=7cm]{{singletons_by_sample.0}.pdf}}}}

% Average depth by sample
%
\hslide{Average depth by sample}{\vbox{\centerline{\includegraphics[height=7cm]{{dp_by_sample.0}.pdf}}}}

% Number of SNPs by sample
%
\hslide{Number of SNPs by sample}{\vbox{\centerline{\includegraphics[height=7cm]{{snps_by_sample.0}.pdf}}}}

% Number of indels by sample
%
\hslide{Number of indels by sample}{\vbox{\centerline{\includegraphics[height=7cm]{{indels_by_sample.0}.pdf}}}}
...
%
\hslide{Number of HETs by AF}{\includegraphics[width=15cm]{{hwe.0}.pdf}}
