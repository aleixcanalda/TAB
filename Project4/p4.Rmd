...
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: The gene_id, the bp_length and its symbol
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: We have a total of 87 individuals, none are filtered since we have information for all of them, we have 26 individuals at an early stage and 61 at a late stage, 58037 genes.
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: TMM takes into account three different factors, while RPKM doesn't, thyat's why TMM is more centered on the 0, therefore not presenting genes that are differentially expressed, which is what we would expect. There is no clear improvement when comparing the first two graphs but there is when comparing the 1st and the 3rd. 
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: 1 is underexpressed, 29 are overexpressed comparing the patients with early and late stages.
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: There are 32 genes. Two genes probably have two different entrezid even though they're the same gene.
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:  28
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: Many genes differentially expressed seem to be related with muscular functions and also actin-related processes.
