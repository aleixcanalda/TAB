...
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:Per cada gen tenim el ID del gen, la longitud en parells de bases i el símbol del gen.
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: Tenim 87 individus, dels quals no hem hagut d'eliminar-ne cap. D'aquest total, 26 estan en un estadi temprà i 61 es troben en un estadi avançat. A més dels individus tenim la informarció de 58037 gens.
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: Amb la normalització RPKM no es veu gaire millora, ja que la línia vermella hauria d'estar com més a prop del 0 millor. En aquest cas veiem que fent la correcció no millora gaire. En canvi, utilitzant el TMM podem veure que la línia s'apropa més al zero que les dades sense normalitzar. Per tant, el millor mètode de normalització és el TMM. Això és degut a que aquest té en compte que el nombre de counts sigui proporcional al nivell d'expressió de l'mRNA mentre qu el RPKM no ho té en compte. Això és el que permet que es puguin comparar els resultats entre diferents mostres.
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: Tenim 32 gens en la taula. Hauriem de tenir 30 gens però hi ha algun gen que té dues entrades en el Entrez.
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: Fent aquesta funció veiem que ens hem quedat amb 28 gens.
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: Hi ha molts gens diferentment expressats que es relacionen amb bastants processos diferents. N'hi ha uns quants que es relacionen amb processos musculars, també n'hi h a uns quants relacionats amb filaments d'actina. Tenint en compte que és caǹcer de pleura, els gens que hem trobat tenen sentit.
