...
```{r read-plink-data}
setwd("/home/samba/homes/1455605/Project3")
# Read PLINK data of the obestiy dataset
obesity.plink <-  read.plink(bed = "data/obesity/obesity.bed",
                             bim = "data/obesity/obesity.bim",
                             fam = "data/obesity/obesity.fam")
```
...
```{r obesity}
obesity.phenotype <- read.delim("data/obesity/obesity.txt")
...
```{r transform-data}
snpgdsBED2GDS("data/obesity/obesity.bed",
              "data/obesity/obesity.fam",
              "data/obesity/obesity.bim",
              out="obesityGDS"
              )
```
...
rs7349742, rs12201995, rs6931936, rs1935960
...
The first SNP doesn't, the second also doesn't, the third and the fourth do overlap.
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
